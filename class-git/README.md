...
> Enlace a la documentación en GitHub de <a href="https://docs.github.com/es/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax" rel="noopener noreferrer" target=" _blank">MARKDOWN</a>
...
touch historia.txt
code .
#Modificamos el archivo historia.txt colocando lo siguiente: Bienvenido     mi nombre es Felipe
ctrl + s
git status
git add .
git status
